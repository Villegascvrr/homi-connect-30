        ...
        <div className="container mx-auto px-4 py-8 max-w-4xl">
          <Card className="shadow-md">
            <CardContent className="p-6 md:p-8">
              <h1 className="text-3xl font-bold mb-6 text-center">Términos de Servicio de Homi</h1>
              ...
              <div className="prose prose-slate max-w-none space-y-5">
                <p>
                  Bienvenido a Homi. Por favor, lea detenidamente estos Términos de Servicio antes de utilizar
                ...
                <div>
                  ...
                  <p>
                    Al registrarse y utilizar Homi, usted acepta estos Términos de Servicio en su totalidad.
                ...
                <div>
                  ...
                  <p>
                    Homi es una plataforma que conecta a estudiantes universitarios y jóvenes profesionales
                ...
                <div>
                  ...
                  <p>Al utilizar Homi, usted acepta no:</p>
                  <ul className="list-disc pl-6 space-y-1">
                ...
                <div>
                  ...
                  <p>
                    Al publicar contenido en Homi, usted garantiza que tiene los derechos necesarios para dicho
                    contenido y que no infringe derechos de terceros. Otorga a Homi una licencia mundial,
                ...
                <div>
                  ...
                  <p>
                    ...
                    compartir información personal sensible. Homi no se hace responsable de las interacciones entre usuarios
                ...
                <div>
                  ...
                  <p>
                    Podemos suspender o terminar su acceso a Homi si consideramos que ha violado estos términos
                ...
                <div>
                  ...
                  <p>
                    En la medida permitida por la ley, Homi no será responsable por daños indirectos, incidentales,
